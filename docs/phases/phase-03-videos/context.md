...
- `nestjs-project` — serviço de armazenamento e processamento em segundo plano
- `next-frontend` — no specific note

**Deferred subprojects:** _None_

**Sequencing notes:** _None_
...
|-----|--------|-------|-------|--------|----------|-----------|
| phase-03-videos/TD-01 | phase | Backend | Job Queue Technology | pending | — | — |
| phase-03-videos/TD-02 | phase | Backend | Upload Strategy for 10GB Files | pending | — | — |
| phase-03-videos/TD-03 | phase | Backend | Video Worker Infrastructure | pending | — | — |
| phase-03-videos/TD-04 | phase | Backend | Video Streaming Protocol | pending | — | — |
| phase-03-videos/TD-05 | phase | Backend | Video Identifier (URL Generation) | pending | — | — |
| phase-03-videos/TD-06 | phase | Backend | Video Status Lifecycle | pending | — | — |
| phase-03-videos/TD-07 | phase | Backend | Object Storage Organization | pending | — | — |
...
_No current-scope TDs decided yet._

## Inherited Decisions Detail

_(inherited TDs from prior phases)_
...
|---------------|-----------------|
| Video entity + migration | Unit + Integration (DB real) |
| Upload controller + service | Unit + Integration (MSW upstream) |
| Queue service (Bull) | Unit + Integration (Redis real) |
| Video worker (FFmpeg) | Unit + Integration (container real) |
| Streaming endpoint (Range requests) | Unit + Integration |
| E2E workflow | e2e-spec.ts (full cycle: upload → process → stream) |

### next-frontend

| Artifact type | Required layers |
|---------------|-----------------|
| Video upload form | Unit (mocked upload) + Integration (MSW BFF) |
| Video player component | Unit (mocked stream) + Integration (MSW BFF) |
| Video list page | Unit (mocked list) + Integration (MSW BFF) |
| E2E video workflow | e2e-spec.ts (real `/api/**`, upstream faked) |
